...
const postData = [
  ...
  },
  {
    ...
    location: "Lalitpur",
    job_type: "Full Time",
    pay_rate_per_hr_dollar: 20.0,
    skills: ["PHP", "JS", "HTML"],
    liked_by: ["test111", "test1", "test123","Deep"],
    viewed_by: ["test111", "test1", "test123"],
    id: 3,
    user_id: 2,
          ...
          <div key={idx} className="post-bar">
            <div className="post_topbar">
              <div className="usy-dt">
                <img src={"./images/" + post.post_by_username + ".jpeg"}/>
            ...
            <div className="job-status-bar">
              ...
              <a href="./index.html#">
                <i className="fas fa-eye"></i>{post.viewed_by.length}
              </a>
            </div>
          </div>
        ))}
